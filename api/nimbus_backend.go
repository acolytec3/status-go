...
func NewNimbusStatusBackend() StatusBackend {
...
// func (b *nimbusStatusBackend) AccountManager() AccountManager {
// 	return nil
// }
...
func (b *nimbusStatusBackend) SaveAccountAndStartNodeWithKey(acc multiaccounts.Account, conf *params.NodeConfig, password string, keyHex string) error {
...
func (b *nimbusStatusBackend) StartNodeWithAccountAndConfig(account multiaccounts.Account, password string, conf *params.NodeConfig, subaccs []accounts.Account) error {
...
func (b *nimbusStatusBackend) saveNodeConfig(config *params.NodeConfig) error {
	b.mu.Lock()
	defer b.mu.Unlock()
...
// func (b *nimbusStatusBackend) rpcFiltersService() gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return rpcfilters.New(b.statusNode), nil
// 	}
// }

// func (b *nimbusStatusBackend) subscriptionService() gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return subscriptions.New(b.statusNode), nil
// 	}
// }

// func (b *nimbusStatusBackend) accountsService(accountsFeed *event.Feed) gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return accountssvc.NewService(accounts.NewDB(b.appDB), b.multiaccountsDB, b.accountManager, accountsFeed), nil
// 	}
// }

// func (b *nimbusStatusBackend) browsersService() gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return browsers.NewService(browsers.NewDB(b.appDB)), nil
// 	}
// }

// func (b *nimbusStatusBackend) permissionsService() gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return permissions.NewService(permissions.NewDB(b.appDB)), nil
// 	}
// }

// func (b *nimbusStatusBackend) mailserversService() gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
// 		return mailservers.NewService(mailservers.NewDB(b.appDB)), nil
// 	}
// }

// func (b *nimbusStatusBackend) walletService(network uint64, accountsFeed *event.Feed) gethnode.ServiceConstructor {
// 	return func(*gethnode.ServiceContext) (gethnode.Service, error) {
...
func (b *nimbusStatusBackend) startNode(config *params.NodeConfig) (err error) {
	...
	nimbusbridge.NewNimbusWhisperWrapper()
...
func (b *nimbusStatusBackend) reSelectAccount() error {
	panic("reSelectAccount")
...
func (b *nimbusStatusBackend) InjectChatAccount(chatKeyHex, encryptionKeyHex string) error {
	panic("InjectChatAccount")
	// b.mu.Lock()
	// defer b.mu.Unlock()
